...
class SimpleOpenAIModelStreamingTest {
    ...
    @NotNull
    private static TestAgent setupAgent(final WireMockRuntimeInfo wiremock, final JsonMapper objectMapper, final OkHttpClient httpClient, final ExecutorService executor) {
