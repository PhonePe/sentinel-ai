...
public interface AgentMemoryStore {
    List<AgentMemory> findMemories(String scopeId,
                                   MemoryScope scope,
    ...
    default List<AgentMemory> findMemoriesAboutUser(String userId,
                                                    String query,
                                                    int count) {
        return findMemories(userId,
                            MemoryScope.ENTITY,
    ...
    default List<AgentMemory> findProcessMemory(String query) {
        return findMemories(null,
                            MemoryScope.AGENT,
                            EnumSet.of(MemoryType.PROCEDURAL),
                            List.of(),
                            query,
                            0,
                            10);
