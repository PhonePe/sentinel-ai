...
public class OutputContainsExpectationExecutor<T> implements ExpectationExecutor<String, T> {
    ...
    /**
     * Creates an executor for output substring expectations.
     *
    ...
    /**
     * Checks whether the output contains the configured substring.
     *
     * @param result  output string to inspect
     * @param context evaluation context (unused)
     * @return {@code true} when the substring is present
     */
    @Override
